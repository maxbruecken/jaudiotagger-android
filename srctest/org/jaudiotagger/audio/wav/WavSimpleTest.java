...
public class WavSimpleTest extends AbstractTestCase
{
    ...
    public void testReadStereoFloatingPointFile()
    {
        ...
        try
        {
            ...
            assertEquals(0.32897958159446716d, f.getAudioHeader().getPreciseTrackLength(), 1e-6);
            assertTrue(f.getTag() instanceof WavTag);
        }
        catch (Exception e)
        {
    ...
    public void testReadQuadChannelFile()
    {
        ...
        try
        {
            ...
            assertEquals(4.784897804260254d, f.getAudioHeader().getPreciseTrackLength(), 1e-6);
            assertTrue(f.getTag() instanceof WavTag);
        }
        catch (Exception e)
        {
